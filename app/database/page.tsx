    ...
    <section className="db-main">
      ...
      <div className="g-grid" id="grid">
        <div className="g-entry" data-category="Lokal">
          <div className="g-img"><Image src={gundalaImg} alt="Gundala" /></div>
        ...
        <div className="g-entry" data-category="Lokal">
          <div className="g-img"><Image src={sriAsihImg} alt="Sri Asih" /></div>
          <span className="cat">Lokal</span>
          <h3>Sri Asih</h3>
        ...
        <div className="g-entry" data-category="Manga">
          <div className="g-img"><Image src={onePieceImg} alt="One Piece" /></div>
        ...
        <div className="g-entry" data-category="Manhwa">
          <div className="g-img"><Image src={soloLevelingImg} alt="Solo Leveling" /></div>
        ...
        <div className="g-entry" data-category="Barat">
          <div className="g-img"><Image src={spiderManImg} alt="The Amazing Spider-Man" /></div>
        ...
        <div className="g-entry" data-category="Manhua">
          <div className="g-img"><Image src={theKingsImg} alt="The King's Avatar" /></div>
